...
class Runner(object):
    def __init__(self, config):
        ...
        if self.all_args.algorithm_name == "happo":
            from MAPPO.algorithms.happo.happo_trainer import HAPPO as TrainAlgo
            from MAPPO.algorithms.happo.policy import HAPPO_Policy as Policy
        elif self.all_args.algorithm_name == "hatrpo":
            from MAPPO.algorithms.hatrpo.hatrpo_trainer import HATRPO as TrainAlgo
            from MAPPO.algorithms.hatrpo.policy import HATRPO_Policy as Policy
        else:
