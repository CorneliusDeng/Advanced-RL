...
class Runner(object):
    ...
    def __init__(self, config):
        ...
        if self.algorithm_name == "mat" or self.algorithm_name == "mat_dec":
            from MAPPO.algorithms.mat.mat_trainer import MATTrainer as TrainAlgo
            from MAPPO.algorithms.mat.algorithm.transformer_policy import TransformerPolicy as Policy
        else:
