...
from MAPPO.envs.football.Football_Env import FootballEnv
...
def main(args):
    ...
    if all_args.share_policy:
        from MAPPO.runner.shared.football_runner import FootballRunner as Runner
    else:
        from MAPPO.runner.separated.football_runner import FootballRunner as Runner
